...
public class ReflectTest3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SuperClass.class.getDeclaredFields().length); // 2
        System.out.println(SuperClass.class.getFields().length); // 2
        System.out.println("-------------------");
        System.out.println("ChildClass info:");
        System.out.println(ChildClass.class.getClassLoader()); //app
        System.out.println(ChildClass.class.getDeclaredFields().length); // 1
        System.out.println(ChildClass.class.getFields().length); // 3
    }
}
